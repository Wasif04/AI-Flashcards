...
export default function Generate() {
    ...
    const {isLoaded, isSignedI, user} = useUser()
    ...
    return <Container maxWidth="md">
        <Box sx={{
            ...
            <Paper sx={{p: 4, width: '100%'}}>
                <TextField value={text} onChange={(e) => setText(e.target.value)} label = "Enter Text" fullWidth multiline rows={4} variant="outlined" sx={{
                    mb: 2,
                }}/>
                <Button
